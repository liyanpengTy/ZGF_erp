...
from app.api.v1.system import user_ns, role_ns, menu_ns, factory_ns, log_ns, monitor_ns, reward_ns, employee_wage_ns
...
api.add_namespace(employee_wage_ns, path='/system/employee-wage')
