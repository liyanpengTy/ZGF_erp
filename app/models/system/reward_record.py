...
class RewardRecord(BaseModel):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey('sys_user.id'), comment='触发奖励的用户ID')
    factory_id = db.Column(db.Integer, db.ForeignKey('sys_factory.id'), comment='奖励目标工厂ID')
    ...
    trigger_value = db.Column(db.Integer, comment='触发时的统计值')
