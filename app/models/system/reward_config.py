...
class RewardConfig(BaseModel):
    ...
    rule_type = db.Column(db.String(20), nullable=False, default='invite_count', comment='规则类型，例如 invite_count')
    threshold = db.Column(db.Integer, nullable=False, comment='触发阈值')
