...
class OperationLog(db.Model):
    ...
    __table_args__ = (
        db.Index('idx_sys_operation_log_user_time', 'user_id', 'create_time'),
        db.Index('idx_sys_operation_log_factory_time', 'factory_id', 'create_time'),
        db.Index('idx_sys_operation_log_status_time', 'status', 'create_time'),
        {'comment': '操作日志表'},
    )
...
class LoginLog(db.Model):
    ...
    __table_args__ = (
        db.Index('idx_sys_login_log_user_time', 'user_id', 'create_time'),
        db.Index('idx_sys_login_log_username_time', 'username', 'create_time'),
        db.Index('idx_sys_login_log_status_time', 'status', 'create_time'),
        {'comment': '登录日志表'},
    )
