...
class WorkCuttingReport(BaseModel):
    ...
    template_id = db.Column(db.Integer, db.ForeignKey("prd_bundle_template.id"), comment="本次生成菲使用的模板 ID")
    ...
    report_user_id = db.Column(db.Integer, db.ForeignKey("sys_user.id"), nullable=False, comment="报工人 ID")
